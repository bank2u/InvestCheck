...
export default function ProjectionChart({ projections, years }) {
    ...
    return (_jsxs("div", { className: "projection-chart", children: [_jsxs("svg", { viewBox: `0 0 ${padding.left + 100 - padding.right} 300`, className: "chart-svg", children: [[0, 0.25, 0.5, 0.75, 1].map((ratio, i) => {
                    ...
                    }), _jsx("line", { x1: padding.left, y1: padding.top, x2: padding.left, y2: 300 - padding.bottom, stroke: "#ddd", strokeWidth: "1" }), _jsx("line", { x1: padding.left, y1: 300 - padding.bottom, x2: 100 - padding.right, y2: 300 - padding.bottom, stroke: "#ddd", strokeWidth: "1" }), [0, 0.25, 0.5, 0.75, 1].map((ratio, i) => {
                        const y = yScale((ratio / 1) * maxBalance);
                        return (_jsx("line", { x1: padding.left, y1: y, x2: 100 - padding.right, y2: y, stroke: "#f5f5f5", strokeWidth: "1" }, `grid-${i}`));
