...
export const ALLOCATIONS: Record<RiskLevel, AllocationSet> = {
  ...
  2: {
    debt: { name: 'เงินฝาก & พันธบัตร', percentage: 75, color: '#10b981' },
    equity: { name: 'หุ้น', percentage: 15, color: '#f59e0b' },
    cash: { name: 'เงินสด', percentage: 0, color: '#3b82f6' },
  ...
  4: {
    debt: { name: 'เงินฝาก & พันธบัตร', percentage: 35, color: '#10b981' },
    equity: { name: 'หุ้น', percentage: 40, color: '#f59e0b' },
    cash: { name: 'เงินสด', percentage: 0, color: '#3b82f6' },
    alternative: { name: 'ทางเลือก', percentage: 25, color: '#8b5cf6' },
  },
  5: {
    debt: { name: 'เงินฝาก & พันธบัตร', percentage: 25, color: '#10b981' },
    equity: { name: 'หุ้น', percentage: 50, color: '#f59e0b' },
    cash: { name: 'เงินสด', percentage: 0, color: '#3b82f6' },
    alternative: { name: 'ทางเลือก', percentage: 25, color: '#8b5cf6' },
  },
};
